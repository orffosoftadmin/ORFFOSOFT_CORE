...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Orffosoft Controller Module")
				.description("Orffosoft Controller Module Documentation")
				.termsOfServiceUrl("http://www-03.ibm.com/software/sla/sladb.nsf/sla/bm?Open").contact("marksolution")
				.license("orffosoftL").licenseUrl("https://orffosoft .com/LICENSE").version("1.0").build();
	}
