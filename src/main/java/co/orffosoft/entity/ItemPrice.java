...
public class ItemPrice implements Serializable{
	...
	@ManyToOne
	@JoinColumn(name = "item_price_store_entity_fk", columnDefinition = "id", foreignKey = @ForeignKey(name = "fk_entity_id"))
	private EntityMaster storeEntity;
	
	@Column(name="item_barcode_number")
	private String item_barcode_number;

	@Column(name="item_closing_stock")
	private Double item_closing_stock;
