...
//	private StockTransfer stockTransfer;
	...
	private Double grn_D_Item_Qnty;
	...
	private Double grn_D_Cgst_Percentage;
	
	@Column(name = "grn_d_sgst_percentage")
	private Double grn_D_Sgst_Percentage;
	...
	@Column(name = "grn_d_mrp")
	private Double grn_D_Mrp;
	
	@ManyToOne
	@JoinColumn(name = "grn_store_entity_fk", columnDefinition = "id", foreignKey = @ForeignKey(name = "fk_entity_id"))
	...
	@Transient
	private Double oldQnty;
	
	@Transient
	private Double oldSellingAmount;
	
	@Transient
	private Double oldPurchaseAmount;
	
	@Transient
	private Boolean diseabled;
	
	@Transient
	private Boolean stock_item_status=true;
